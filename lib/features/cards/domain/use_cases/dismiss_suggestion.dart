...
class DismissSuggestion
    implements UseCase<TagCardEntity, DismissSuggestionParams> {
  ...
  @override
  Future<TagCardEntity> call(DismissSuggestionParams params) async {
    final result = await _cardRepository.dismissSuggestion(params.cardId);
...
class DismissSuggestionParams extends Equatable {
  const DismissSuggestionParams({required this.cardId});
