// ignore_for_file: avoid_positional_boolean_parameters, curly_braces_in_flow_control_structures, deprecated_member_use
//
// Vendored from cactus-compute/cactus v1.14 flutter/cactus.dart.
// Source: https://github.com/cactus-compute/cactus/blob/v1.14/flutter/cactus.dart
...
typedef TokenCallbackNative =
    Void Function(Pointer<Utf8> token, Uint32 tokenId, Pointer<Void> userData);
typedef TokenCallbackDart =
    void Function(Pointer<Utf8> token, int tokenId, Pointer<Void> userData);

typedef CactusInitNative =
    CactusModelT Function(
      Pointer<Utf8> modelPath,
      Pointer<Utf8> corpusDir,
      Bool cacheIndex,
    );
...
typedef CactusScoreWindowNative =
    Int32 Function(
      CactusModelT model,
...
typedef CactusTranscribeNative =
    Int32 Function(
      CactusModelT model,
...
typedef CactusDetectLanguageNative =
    Int32 Function(
      CactusModelT model,
      Pointer<Utf8> audioFilePath,
      Pointer<Utf8> responseBuffer,
...
typedef CactusStreamTranscribeStartNative =
    CactusStreamTranscribeT Function(
      CactusModelT model,
      Pointer<Utf8> optionsJson,
    );
typedef CactusStreamTranscribeProcessNative =
    Int32 Function(
...
typedef CactusStreamTranscribeStopNative =
    Int32 Function(
      CactusStreamTranscribeT stream,
      Pointer<Utf8> responseBuffer,
      IntPtr bufferSize,
...
typedef CactusImageEmbedNative =
    Int32 Function(
      CactusModelT model,
...
typedef CactusAudioEmbedNative =
    Int32 Function(
      CactusModelT model,
...
typedef CactusEmbedSpeakerNative =
    Int32 Function(
      CactusModelT model,
      Pointer<Utf8> audioFilePath,
      Pointer<Utf8> responseBuffer,
...
typedef CactusIndexInitNative =
    CactusIndexT Function(Pointer<Utf8> indexDir, IntPtr embeddingDim);
typedef CactusIndexAddNative =
    Int32 Function(
      CactusIndexT index,
      Pointer<Int32> ids,
...
typedef CactusIndexDeleteNative =
    Int32 Function(CactusIndexT index, Pointer<Int32> ids, IntPtr idsCount);
typedef CactusIndexQueryNative =
    Int32 Function(
      CactusIndexT index,
      Pointer<Pointer<Float>> embeddings,
...
typedef CactusSetTelemetryEnvironmentNative =
    Void Function(
...
typedef CactusDetectLanguageDart =
    int Function(
      CactusModelT model,
      Pointer<Utf8> audioFilePath,
      Pointer<Utf8> responseBuffer,
...
typedef CactusStreamTranscribeStartDart =
    CactusStreamTranscribeT Function(
      CactusModelT model,
      Pointer<Utf8> optionsJson,
    );
typedef CactusStreamTranscribeProcessDart =
    int Function(
      CactusStreamTranscribeT stream,
      Pointer<Uint8> pcmBuffer,
      int pcmBufferSize,
...
typedef CactusStreamTranscribeStopDart =
    int Function(
      CactusStreamTranscribeT stream,
      Pointer<Utf8> responseBuffer,
      int bufferSize,
...
typedef CactusEmbedSpeakerDart =
    int Function(
      CactusModelT model,
      Pointer<Utf8> audioFilePath,
      Pointer<Utf8> responseBuffer,
...
typedef CactusIndexInitDart =
    CactusIndexT Function(Pointer<Utf8> indexDir, int embeddingDim);
typedef CactusIndexAddDart =
    int Function(
      CactusIndexT index,
      Pointer<Int32> ids,
      Pointer<Pointer<Utf8>> documents,
...
typedef CactusIndexDeleteDart =
    int Function(CactusIndexT index, Pointer<Int32> ids, int idsCount);
typedef CactusIndexQueryDart =
    int Function(
      CactusIndexT index,
      Pointer<Pointer<Float>> embeddings,
      int embeddingsCount,
...
typedef CactusSetTelemetryEnvironmentDart =
    void Function(
      Pointer<Utf8> framework,
      Pointer<Utf8> cacheLocation,
      Pointer<Utf8> version,
...
typedef CactusLogSetCallbackNative =
    Void Function(
      Pointer<NativeFunction<LogCallbackNative>> callback,
      Pointer<Void> userData,
    );
typedef CactusLogSetCallbackDart =
    void Function(
      Pointer<NativeFunction<LogCallbackNative>> callback,
      Pointer<Void> userData,
    );

typedef CactusIndexGetNative =
    Int32 Function(
      CactusIndexT index,
      Pointer<Int32> ids,
      IntPtr idsCount,
...
final _cactusInit = _lib.lookupFunction<CactusInitNative, CactusInitDart>(
  'cactus_init',
);
final _cactusDestroy = _lib
    .lookupFunction<CactusDestroyNative, CactusDestroyDart>('cactus_destroy');
final _cactusReset = _lib.lookupFunction<CactusResetNative, CactusResetDart>(
  'cactus_reset',
);
final _cactusStop = _lib.lookupFunction<CactusStopNative, CactusStopDart>(
  'cactus_stop',
);
final _cactusComplete = _lib
    .lookupFunction<CactusCompleteNative, CactusCompleteDart>(
      'cactus_complete',
    );
final _cactusPrefill = _lib
    .lookupFunction<CactusPrefillNative, CactusPrefillDart>('cactus_prefill');
final _cactusTokenize = _lib
    .lookupFunction<CactusTokenizeNative, CactusTokenizeDart>(
      'cactus_tokenize',
    );
final _cactusScoreWindow = _lib
    .lookupFunction<CactusScoreWindowNative, CactusScoreWindowDart>(
      'cactus_score_window',
    );
final _cactusTranscribe = _lib
    .lookupFunction<CactusTranscribeNative, CactusTranscribeDart>(
      'cactus_transcribe',
    );
final _cactusStreamTranscribeStart = _lib
    .lookupFunction<
      CactusStreamTranscribeStartNative,
      CactusStreamTranscribeStartDart
    >('cactus_stream_transcribe_start');
final _cactusStreamTranscribeProcess = _lib
    .lookupFunction<
      CactusStreamTranscribeProcessNative,
      CactusStreamTranscribeProcessDart
    >('cactus_stream_transcribe_process');
final _cactusStreamTranscribeStop = _lib
    .lookupFunction<
      CactusStreamTranscribeStopNative,
      CactusStreamTranscribeStopDart
    >('cactus_stream_transcribe_stop');
final _cactusEmbed = _lib.lookupFunction<CactusEmbedNative, CactusEmbedDart>(
  'cactus_embed',
);
final _cactusImageEmbed = _lib
    .lookupFunction<CactusImageEmbedNative, CactusImageEmbedDart>(
      'cactus_image_embed',
    );
final _cactusAudioEmbed = _lib
    .lookupFunction<CactusAudioEmbedNative, CactusAudioEmbedDart>(
      'cactus_audio_embed',
    );
final _cactusVad = _lib.lookupFunction<CactusVadNative, CactusVadDart>(
  'cactus_vad',
);
final _cactusDiarize = _lib
    .lookupFunction<CactusDiarizeNative, CactusDiarizeDart>('cactus_diarize');
final _cactusEmbedSpeaker = _lib
    .lookupFunction<CactusEmbedSpeakerNative, CactusEmbedSpeakerDart>(
      'cactus_embed_speaker',
    );
final _cactusRagQuery = _lib
    .lookupFunction<CactusRagQueryNative, CactusRagQueryDart>(
      'cactus_rag_query',
    );
final _cactusIndexInit = _lib
    .lookupFunction<CactusIndexInitNative, CactusIndexInitDart>(
      'cactus_index_init',
    );
final _cactusIndexAdd = _lib
    .lookupFunction<CactusIndexAddNative, CactusIndexAddDart>(
      'cactus_index_add',
    );
final _cactusIndexDelete = _lib
    .lookupFunction<CactusIndexDeleteNative, CactusIndexDeleteDart>(
      'cactus_index_delete',
    );
final _cactusIndexQuery = _lib
    .lookupFunction<CactusIndexQueryNative, CactusIndexQueryDart>(
      'cactus_index_query',
    );
final _cactusIndexCompact = _lib
    .lookupFunction<CactusIndexCompactNative, CactusIndexCompactDart>(
      'cactus_index_compact',
    );
final _cactusIndexDestroy = _lib
    .lookupFunction<CactusIndexDestroyNative, CactusIndexDestroyDart>(
      'cactus_index_destroy',
    );
final _cactusGetLastError = _lib
    .lookupFunction<CactusGetLastErrorNative, CactusGetLastErrorDart>(
      'cactus_get_last_error',
    );
final _cactusSetTelemetryEnvironment = _lib
    .lookupFunction<
      CactusSetTelemetryEnvironmentNative,
      CactusSetTelemetryEnvironmentDart
    >('cactus_set_telemetry_environment');
final _cactusTelemetryFlush = _lib
    .lookupFunction<CactusTelemetryFlushNative, CactusTelemetryFlushDart>(
      'cactus_telemetry_flush',
    );
final _cactusTelemetryShutdown = _lib
    .lookupFunction<CactusTelemetryShutdownNative, CactusTelemetryShutdownDart>(
      'cactus_telemetry_shutdown',
    );
final _cactusSetAppId = _lib
    .lookupFunction<CactusSetAppIdNative, CactusSetAppIdDart>(
      'cactus_set_app_id',
    );
final _cactusIndexGet = _lib
    .lookupFunction<CactusIndexGetNative, CactusIndexGetDart>(
      'cactus_index_get',
    );
final _cactusDetectLanguage = _lib
    .lookupFunction<CactusDetectLanguageNative, CactusDetectLanguageDart>(
      'cactus_detect_language',
    );
final _cactusLogSetLevel = _lib
    .lookupFunction<CactusLogSetLevelNative, CactusLogSetLevelDart>(
      'cactus_log_set_level',
    );
final _cactusLogSetCallback = _lib
    .lookupFunction<CactusLogSetCallbackNative, CactusLogSetCallbackDart>(
...
class _Calloc implements Allocator {
  ...
  static final _freePtr = _lib
      .lookup<NativeFunction<Void Function(Pointer<Void>)>>('free');
  static final _calloc = _callocPtr
...
String cactusStreamTranscribeStop(CactusStreamTranscribeT stream) {
  ...
  try {
    final result = _cactusStreamTranscribeStop(
      stream,
      responseBuffer.cast(),
      bufferSize,
    );
...
int cactusIndexAdd(
  ...
  final metadatasPtr = metadatas != null
      ? calloc<Pointer<Utf8>>(count)
      : nullptr;
  if (metadatas != null) {
